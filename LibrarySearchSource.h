...
@class MFMailMessage, MFMailMessageLibrary, MFMessageCriterion, MessageToMailboxUidCache, NSArray, NSMutableSet, NSNumber, NSObject<OS_dispatch_queue>, NSString, SearchManager, SourceSearchContext;
...
@property(retain, nonatomic) MFMailMessage *oldestKnownMessage; // @synthesize oldestKnownMessage=_oldestKnownMessage;
...
- (void)_queue_updateMessages:(id)arg1 flags:(id)arg2 usingCriterion:(id)arg3;
...
- (void)_notifyMallWithModifiedMessages:(id)arg1 flags:(id)arg2;
- (void)_notifyMallWithAddedMessages:(id)arg1 removedMessages:(id)arg2 group:(id)arg3;
- (void)searchManager:(id)arg1 finishedSearchWithIdentifier:(id)arg2;
- (void)searchManager:(id)arg1 foundMessages:(id)arg2 forSearchWithIdentifier:(id)arg3 shouldWait:(_Bool)arg4;
...
@property(readonly, retain, nonatomic) MFMessageCriterion *baseCriterion;
@property(readonly, retain, nonatomic) MFMessageCriterion *effectiveCriterion;
