...
@class MFMessageBulletinsFilter, MFMessageResultsGenerator, NSLock, NSMapTable, NSMutableDictionary, NSMutableSet, NSObject<OS_dispatch_queue>, NSString;
...
@interface MFMessageBulletinsObserver : NSObject <MFAddressBookClient>
{
    ...
    MFMessageBulletinsFilter *_messageBulletinsFilter;
