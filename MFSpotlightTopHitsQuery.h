...
@class CSTopHitSearchQuery, MFPromise, NSArray, NSLock, NSMutableArray, NSProgress, NSString;

@interface MFSpotlightTopHitsQuery : NSObject <MFCancelable, NSProgressReporting>
{
    ...
    MFPromise *_spotlightTopHitsQueryResultPromise;
...
@property(retain, nonatomic) MFPromise *spotlightTopHitsQueryResultPromise; // @synthesize spotlightTopHitsQueryResultPromise=_spotlightTopHitsQueryResultPromise;
...
- (void)cancel;
- (void)start;
- (id)spotlightTopHitsQueryResultFuture;
