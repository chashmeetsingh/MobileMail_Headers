...
@class UIView, _MFTiltedTabCloseButton, _TabGradientView;

@interface _MFTiltedTabItemView : MFSceneView
{
    ...
    UIView *_closeButtonWrapperView;
    UIView *_contentClipperView;
    UIView *_maskCutoutView;
    ...
    struct UIEdgeInsets _contentClippingInsets;
}
...
@property(nonatomic) struct UIEdgeInsets contentClippingInsets; // @synthesize contentClippingInsets=_contentClippingInsets;
...
@property(retain, nonatomic) UIView *maskCutoutView; // @synthesize maskCutoutView=_maskCutoutView;
@property(readonly, nonatomic) UIView *contentClipperView; // @synthesize contentClipperView=_contentClipperView;
@property(readonly, nonatomic) UIView *closeButtonWrapperView; // @synthesize closeButtonWrapperView=_closeButtonWrapperView;
- (void)dealloc;
