...
@class MFMailMessageStore, MFMailboxSourceMessageCache, MFMessageRuleManager, NSArray, NSString;
...
@property(retain, nonatomic) MFMailboxSourceMessageCache *messageCache; // @synthesize messageCache=_messageCache;
...
- (id)storeSearchResultUsingSearchContext:(id)arg1 limit:(unsigned long long)arg2 error:(id *)arg3;
