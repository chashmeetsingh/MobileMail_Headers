...
- (void)updateFlagsFromMessage:(MFMailMessage *)arg1 isUnread:(_Bool)arg2 isFlagged:(_Bool)arg3;
...
- (void)setMessage:(MFMailMessage *)arg1 entryStyle:(unsigned long long)arg2;
