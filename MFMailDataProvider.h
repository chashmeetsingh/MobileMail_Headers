...
@interface MFMailDataProvider : NSObject <MFMessageBulletinsObserverDelegate, MFDelayedMessagesPresenterDelegate, BBRemoteDataProvider>
{
    ...
    struct os_unfair_lock_s _summaryFetchTimeLock;
    _Bool _shouldInvalidateBulletinsForUnlock;
...
@property(nonatomic) _Bool shouldInvalidateBulletinsForUnlock; // @synthesize shouldInvalidateBulletinsForUnlock=_shouldInvalidateBulletinsForUnlock;
- (void).cxx_destruct;
...
- (void)updateClearedInfoCutoffDatesForMailboxes:(id)arg1;
