...
@property(retain, nonatomic) NSMutableArray *sortedAccountsMailboxes; // @synthesize sortedAccountsMailboxes=_sortedAccountsMailboxes;
@property(copy, nonatomic) NSArray *visibleAccounts; // @synthesize visibleAccounts=_visibleAccounts;
- (void).cxx_destruct;
