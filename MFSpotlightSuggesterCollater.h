...
@class MFLazyCache, MFSearchSuggestionPhraseManager, MFSpotlightContactsHelper, NSArray, NSMutableArray, NSMutableDictionary, NSMutableSet, NSProgress, NSString;
...
@property(readonly, nonatomic) MFSearchSuggestionPhraseManager *phraseManager; // @synthesize phraseManager=_phraseManager;
- (void).cxx_destruct;
@property(readonly, nonatomic) NSArray *sortedSuggestions;
...
- (long long)_integerFromResultRelevance:(id)arg1;
